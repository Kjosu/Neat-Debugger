...
/**
 * Font Awesome Loader/Helper class by Marcel Mühlberg
 */
public class FontAwesome
{
	public static final String FAMILY_NAME = "Font Awesome 5 Free";

    public static void init() throws IOException {
    	javafx.scene.text.Font.loadFont(FontAwesome.class.getClassLoader().getResource("fonts/fontawesome-webfont.ttf").openStream(), 10);
    }

    public static javafx.scene.text.Font font() {
    	return javafx.scene.text.Font.font(FAMILY_NAME);
    }
